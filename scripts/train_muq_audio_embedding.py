...
def parser() -> argparse.ArgumentParser:
    ...
    result.add_argument("--validation-batch-size", type=int, default=64)
    result.add_argument("--num-workers", type=int, default=6)
    ...
    result.add_argument("--retrieval-block-size", type=int, default=512)
